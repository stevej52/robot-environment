...
on the same network. It is the walk-away variant of the host PC install in
[docs/environment.md](../docs/environment.md) sections 2 and 3.

The installer fetches the file from this URL (the repository is public):

    https://raw.githubusercontent.com/stevej52/robot-environment/main/host-pc/autoinstall.yaml
